...
Route::prefix('mgr')->name('mgr.')->group(function (){
    ...
    Route::match(array('GET','POST'),'member/department_view_data', [Mgr\MemberController::class, 'department_view_data'])->name('member.department_view_data');
    ...
    Route::post('committeeman/switch_toggle_com', [Mgr\CommitteemanController::class, 'switch_toggle_com'])->name('committeeman.switch_toggle_com');
    ...
    Route::match(array('GET','POST'),'committeeman/import_data', [Mgr\CommitteemanController::class, 'import_data'])->name('committeeman.import_data');
    /////0522
