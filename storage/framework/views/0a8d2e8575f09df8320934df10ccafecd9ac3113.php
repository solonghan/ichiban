    ...
    <script>
        ...
        $(document).ready(function(e){
            ...
            $(document).on('click', '.edit-item-btn', function(event) {
                ...
                location.href = '<?php echo e(env('APP_URL')); ?>/mgr/committeeman/edit/' + id;
            });
        ...
        function load_data(goToPage = false){
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo e(env('APP_URL')); ?>/mgr/<?php echo e($controller??''); ?>/department_view_data',
...
<?php echo $__env->make('mgr.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ichiban\resources\views/mgr/template_list_view_ajax.blade.php ENDPATH**/ ?>