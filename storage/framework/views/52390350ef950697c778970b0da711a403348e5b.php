...
unset($__errorArgs, $__bag); ?>" value="" id="username" name="ID_number" placeholder="請輸入帳號">
...
unset($__errorArgs, $__bag); ?>" name="password" placeholder="請輸入密碼" id="password-input" value="">
...
<?php echo $__env->make('mgr.layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ichiban\resources\views/mgr/auth/login.blade.php ENDPATH**/ ?>