...
class Mgr extends BaseController
{
    ...
    public function __construct()
    {
        ...
        // $this->data['select']['dist'] = Dist::where(['city_id'=>1])->get()->toArray();
        ...
        $this->middleware(function ($request, $next) {
            ...
            $nav = [
                ...
                [['一番賞管理', '', 'PRODUCT', '', 'ri-rocket-line'], [
                    // ['新增外審專家', 'mgr.committeeman.add', 'COMMITTEEMAN', ''],
                    // ['測試資料', 'mgr.committeeman', 'USERS', ''],
                    ['一番賞列表', 'mgr.product', 'PRODUCT', ''],
                    ['標籤', 'mgr.tags', 'TAGS', ''],
                  
                ]],
                [['最新消息', 'mgr.news', 'NEWS', '', 'ri-chat-2-fill'], []],

                [['常見問題', 'mgr.faq', 'FAQS', '', 'ri-chat-2-fill'], []],

                [['合作島主', 'mgr.cooperative_store', 'COOPERATIVE_STORE', '', 'ri-chat-2-fill'], []],
              
              
                [['會員管理', '', 'USERS', '', 'ri-rocket-line'], [
                    // ['新增外審專家', 'mgr.committeeman.add', 'COMMITTEEMAN', ''],
                    // ['測試資料', 'mgr.committeeman', 'USERS', ''],
                    ['會員資料', 'mgr.users', 'USERS', ''],
                  
                ]],
          
                [['權限角色管理', '', 'COMMITTEEMAN', '', 'ri-mail-open-line'], [
